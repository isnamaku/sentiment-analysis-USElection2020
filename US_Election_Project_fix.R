  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "dashboard",
              ...
              h1("Analisis Sentimen Tweet Pada Pemilihan Presiden US 2020 ")
      ...
      tabItem(tabName = "polarity",
              box(
                ...
                collapsible = TRUE,
                plotOutput("plotData2", height = 800, width = 700)
              )
      ),
      tabItem(tabName = "sentiment",
              title = "Table Sentiment",
          DT::dataTableOutput("table", height = 800, width = 1000)
